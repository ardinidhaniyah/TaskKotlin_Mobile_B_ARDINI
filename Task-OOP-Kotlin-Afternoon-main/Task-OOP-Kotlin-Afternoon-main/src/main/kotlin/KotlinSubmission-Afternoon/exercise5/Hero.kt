...
class Hero {
    ...
    fun jalan() {
        checkHealth()
        println("$name sedang berjalan dengan temannya")
        health -= 1
    }

    fun lari() {
        checkHealth()
        println("$name sedang berlari di Taman Ahmad Yani")
        health -= 2
    }

    fun makan() {
        checkHealth()
        println("$name sedang makan ayam")
        health += 2
    }

    fun minum() {
        checkHealth()
        println("$name sedang minum Xiboba")
        health += 2
    }

    fun lompat() {
        checkHealth()
        println("$name sedang lompat-lompat di trampolin")
        health -= 2
    }

    fun duduk() {
        checkHealth()
        println("$name sedang duduk bersama gebetannya")
        health += 1
    }
}
